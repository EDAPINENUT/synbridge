...
class DeltaGraphDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage: str | None = None) -> None:
        ...
        print(f'Number of training instance: {len(self.train_dataset.data)}')
        print(f'Number of validation instance: {len(self.val_dataset.data)}')
        print(f'Number of test instance: {len(self.test_dataset.data)}')
